...
declare global {
  ...
  const useDepositStore: typeof import('./app/stores/deposit').useDepositStore
  const useFormStore: typeof import('./app/stores/form').useFormStore
  const useId: typeof import('vue').useId
  const useLink: typeof import('vue-router').useLink
  const useLocationStore: typeof import('./app/stores/location').useLocationStore
  const useModel: typeof import('vue').useModel
  const useOrderStore: typeof import('./app/stores/order').useOrderStore
  const useProductStore: typeof import('./app/stores/product').useProductStore
  const useProfileStore: typeof import('./app/stores/profile').useProfileStore
  const useRefillStore: typeof import('./app/stores/refill').useRefillStore
